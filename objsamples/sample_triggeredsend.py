...
try:
    ...
    patchTrig = FuelSDK.ET_TriggeredSend()
    ...
    sendTrig.subscribers = [
        {
            "EmailAddress": "testing@bh.exacttarget.com",
            "SubscriberKey": "testing@bh.exacttarget.com",
        }
    ]
    ...
    deleteTrig = FuelSDK.ET_TriggeredSend()
