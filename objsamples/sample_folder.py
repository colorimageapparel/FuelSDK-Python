...
try:
    ...
    # Create Folder
    print(">>> Create Folder")
    postFolder = FuelSDK.ET_Folder()
    postFolder.auth_stub = stubObj
    postFolder.props = {
        "CustomerKey": NameOfTestFolder,
        "Name": NameOfTestFolder,
        "Description": NameOfTestFolder,
        "ContentType": "EMAIL",
        "ParentFolder": {"ID": ParentIDForEmail},
    }
    ...
    # Delete Folder
    print(">>> Delete Folder")
    deleteFolder = FuelSDK.ET_Folder()
