...
try:
    ...
    # Update Email
    print(">>> Update Email")
    patchHTMLBody = FuelSDK.ET_Email()
    patchHTMLBody.auth_stub = stubObj
    patchHTMLBody.props = {
        "CustomerKey": NameOfTestEmail,
        "Name": NameOfTestEmail,
        "HTMLBody": "<b>Some HTML HTMLBody Goes here. NOW WITH NEW HTMLBody</b>",
    }
    ...
    # Delete Email
    print(">>> Delete Email")
    deleteHTMLBody = FuelSDK.ET_Email()
    deleteHTMLBody.auth_stub = stubObj
    deleteHTMLBody.props = {
        "CustomerKey": NameOfTestEmail,
        "Name": NameOfTestEmail,
        "HTMLBody": "<b>Some HTML HTMLBody Goes here. NOW WITH NEW HTMLBody</b>",
    }
