...
try:
    ...
    getContent = FuelSDK.ET_ContentArea()
    ...
    postContent = FuelSDK.ET_ContentArea()
    ...
    getContent.search_filter = {
        "Property": "CustomerKey",
        "SimpleOperator": "equals",
        "Value": NameOfTestContentArea,
    }
    getResponse = getContent.get()
    print("Retrieve Status: " + str(getResponse.status))
    print("Code: " + str(getResponse.code))
    ...
    patchContent = FuelSDK.ET_ContentArea()
    ...
    deleteContent = FuelSDK.ET_ContentArea()
